...
constexpr int MAP_ORIGIN_X     = 0;
constexpr int MAP_ORIGIN_Y     = 0;
constexpr int MAP_DIMENSIONS_X = 0xFF;
constexpr int MAP_DIMENSIONS_Y = 0xFF;
